...
function apiClaimToDemoClaim(c: ApiClaim): DemoClaim {
  return {
    ...
    payerId: c.payer_id || '',
    dos: c.dos_from || '',
    cptCodes: c.cpt_codes || [],
    icdCodes: c.icd_codes || [],
                ...
                {scrubResults.length > 0 ? (
                  ...
                  <div className="flex items-start gap-2 bg-blue-500/10 border border-blue-500/20 rounded-lg p-3">
                    ...
                    <p className="text-[12px] text-blue-400">
                      Click &quot;Run AI Scrub&quot; to check {apiScrubRules.length} rules automatically, or complete the manual checklist below.
                    </p>
                  </div>
                )}
                {/* Manual checklist always available */}
