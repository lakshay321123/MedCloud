    ...
    <ModuleShell title={t("credentialing","title")} subtitle={t("credentialing","subtitle")}>
      ...
      <div className="card p-4 mt-4">
        ...
        <div className="grid grid-cols-5 gap-2 mb-4">
          {[{stage:'Submitted',count:4,color:'bg-blue-500'},{stage:'In Review',count:7,color:'bg-brand-pale'},{stage:'Approved',count:23,color:'bg-brand'},{stage:'Denied',count:1,color:'bg-red-500'},{stage:'Re-credentialing',count:3,color:'bg-purple-500'}].map(s=>(
