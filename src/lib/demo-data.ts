...
export const demoERALineItems: EOBLineItem[] = [
  ...
  { id: 'EOB-004', eraId: 'ERA-001', claimId: 'CLM-4511', patientName: 'Khalid Ibrahim', patientId: 'P-007', cpt: '99215', cptDesc: 'Office visit, est. high', dos: '2026-01-15', billed: 380, allowed: 0, paid: 0, denied: 380, adjCode: 'CO-197', adjReason: 'Timely filing exceeded', patBalance: 0, action: 'deny_route' },
