...
export const demoERALineItems: EOBLineItem[] = [
  { id: 'EOB-001', eraId: 'ERA-001', claimId: 'CLM-4501', patientName: 'John Smith', patientId: 'P-001', cpt: '99214', cptDesc: 'Office visit, est. moderate', modifier: '25', dos: '2026-02-25', billed: 250, allowed: 218, paid: 218, denied: 0, adjCode: 'CO-45', adjReason: 'Contractual adjustment', patBalance: 30, action: 'post' },
  { id: 'EOB-002', eraId: 'ERA-001', claimId: 'CLM-4501', patientName: 'John Smith', patientId: 'P-001', cpt: '93000', cptDesc: 'ECG, routine', modifier: '', dos: '2026-02-25', billed: 85, allowed: 62, paid: 62, denied: 0, adjCode: 'CO-45', adjReason: 'Contractual adjustment', patBalance: 0, action: 'post' },
  { id: 'EOB-003', eraId: 'ERA-001', claimId: 'CLM-4510', patientName: 'Maria Garcia', patientId: 'P-006', cpt: '99213', cptDesc: 'Office visit, est. low', modifier: '', dos: '2026-02-28', billed: 175, allowed: 152, paid: 152, denied: 0, adjCode: 'CO-45', adjReason: 'Contractual adjustment', patBalance: 25, action: 'post' },
  { id: 'EOB-004', eraId: 'ERA-001', claimId: 'CLM-4511', patientName: 'Khalid Ibrahim', patientId: 'P-007', cpt: '99215', cptDesc: 'Office visit, est. high', modifier: '', dos: '2026-02-26', billed: 380, allowed: 0, paid: 0, denied: 380, adjCode: 'CO-197', adjReason: 'Prior auth required — not obtained', patBalance: 0, action: 'deny_route' },
  { id: 'EOB-005', eraId: 'ERA-001', claimId: 'CLM-4512', patientName: 'Linda Torres', patientId: 'P-010', cpt: '99214', cptDesc: 'Office visit, est. moderate', modifier: '', dos: '2026-02-27', billed: 250, allowed: 218, paid: 175, denied: 0, adjCode: 'CO-45', adjReason: 'Contractual + underpaid by $43', patBalance: 30, action: 'review', notes: 'Paid $43 less than contracted rate' },
  { id: 'EOB-006', eraId: 'ERA-002', claimId: 'CLM-4504', patientName: 'Sarah Johnson', patientId: 'P-002', cpt: '99214', cptDesc: 'Office visit, est. moderate', modifier: '', dos: '2026-02-20', billed: 250, allowed: 0, paid: 0, denied: 250, adjCode: 'CO-4', adjReason: 'Prior authorization required', patBalance: 0, action: 'deny_route' },
  { id: 'EOB-007', eraId: 'ERA-002', claimId: 'CLM-4513', patientName: 'Sarah Johnson', patientId: 'P-002', cpt: '99213', cptDesc: 'Office visit, est. low', modifier: '', dos: '2026-02-22', billed: 175, allowed: 156, paid: 131, denied: 0, adjCode: 'PR-2', adjReason: 'Coinsurance', patBalance: 25, action: 'patient_bill' },
  { id: 'EOB-008', eraId: 'ERA-002', claimId: 'CLM-4514', patientName: 'James Wilson', patientId: 'P-011', cpt: '99212', cptDesc: 'Office visit, est. straightforward', modifier: '', dos: '2026-02-24', billed: 110, allowed: 98, paid: 98, denied: 0, adjCode: 'CO-45', adjReason: 'Contractual adjustment', patBalance: 0, action: 'post' },
  { id: 'EOB-009', eraId: 'ERA-003', claimId: 'CLM-4506', patientName: 'Robert Chen', patientId: 'P-005', cpt: '93306', cptDesc: 'TTE with Doppler, complete', modifier: '', dos: '2026-02-20', billed: 650, allowed: 480, paid: 384, denied: 0, adjCode: 'PR-2', adjReason: 'Coinsurance 20%', patBalance: 96, action: 'patient_bill' },
  { id: 'EOB-010', eraId: 'ERA-003', claimId: 'CLM-4506', patientName: 'Robert Chen', patientId: 'P-005', cpt: '93320', cptDesc: 'Doppler echo, complete', modifier: '', dos: '2026-02-20', billed: 320, allowed: 240, paid: 192, denied: 0, adjCode: 'PR-2', adjReason: 'Coinsurance 20%', patBalance: 48, action: 'patient_bill' },
  { id: 'EOB-011', eraId: 'ERA-003', claimId: 'CLM-4515', patientName: 'Emily Williams', patientId: 'P-008', cpt: '99214', cptDesc: 'Office visit, est. moderate', modifier: '', dos: '2026-02-18', billed: 250, allowed: 0, paid: 0, denied: 250, adjCode: 'CO-27', adjReason: 'Expenses not covered — inactive coverage', patBalance: 0, action: 'deny_route' },
  { id: 'EOB-012', eraId: 'ERA-003', claimId: 'CLM-4516', patientName: 'William Davis', patientId: 'P-012', cpt: '93000', cptDesc: 'ECG, routine', modifier: '', dos: '2026-02-22', billed: 85, allowed: 68, paid: 54, denied: 0, adjCode: 'PR-2', adjReason: 'Coinsurance 20%', patBalance: 14, action: 'post' },
  { id: 'EOB-013', eraId: 'ERA-004', claimId: 'CLM-4502', patientName: 'Ahmed Al Mansouri', patientId: 'P-003', cpt: '99213', cptDesc: 'Office visit, est. low', modifier: '', dos: '2026-02-24', billed: 280, allowed: 280, paid: 280, denied: 0, adjCode: '-', adjReason: '-', patBalance: 0, action: 'post' },
  { id: 'EOB-014', eraId: 'ERA-004', claimId: 'CLM-4502', patientName: 'Ahmed Al Mansouri', patientId: 'P-003', cpt: '93000', cptDesc: 'ECG, routine', modifier: '', dos: '2026-02-24', billed: 140, allowed: 140, paid: 140, denied: 0, adjCode: '-', adjReason: '-', patBalance: 0, action: 'post' },
  { id: 'EOB-015', eraId: 'ERA-004', claimId: 'CLM-4517', patientName: 'Fatima Hassan', patientId: 'P-004', cpt: '99203', cptDesc: 'Office visit, new patient', modifier: '', dos: '2026-02-26', billed: 300, allowed: 300, paid: 300, denied: 0, adjCode: '-', adjReason: '-', patBalance: 0, action: 'post' },
]
